...
* history 요청에 request ID를 사용합니다.
* timeout 이후 늦게 도착한 오래된 응답을 무시합니다.
...
추천 목록에서 플레이어를 선택해 태그할 수 있습니다.

### Item tag

Just Chat 화면의 아이템 버튼을 눌러 현재 인벤토리의 아이템을 메시지에 삽입할 수 있습니다.

아이템 정보는 서버에서 검증된 뒤 메시지에 포함됩니다.
